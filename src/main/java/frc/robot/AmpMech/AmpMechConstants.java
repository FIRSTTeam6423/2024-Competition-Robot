...
public final class AmpMechConstants {
    ...
    public static final double AMP_MECH_PIVOT_P = 0.025;
    public static final double AMP_MECH_PIVOT_I = 0;
    public static final double AMP_MECH_PIVOT_D = 0;
    public static final double AMP_MECH_MAX_VELOCITY_DEG_PER_SEC = 600;
    public static final double AMP_MECH_MAX_ACCELERATION_DEG_PER_SEC_SQUARED = 600;
    ...
    public static final double AMP_MECH_DEPOSIT_SPEED = 0.2;
